...
const About = () => {
    return (
        <div name="about" className="pt-60 md:pt-0 w-full h-screen bg-gradient-to-b from-gray-800 to-black text-white">
            <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white'>
                <div className="pb-4">
                    <p className="text-4xl font-bold inline border-b-4 border-gray-500">About</p>
                </div>
                <p className="text-xl mt-10">
                I'm Hummad, a frontend developer passionate about crafting user-friendly and visually appealing websites. With expertise in HTML, CSS, JavaScript and React, I specialize in creating responsive interfaces that enhance the user experience. I strive to stay updated with the latest technologies and best practices to deliver high-quality work. Let's collaborate to bring your web projects to life!
                </p>
